...
DEFAULT_FILE_STORAGE = 'rpi_server.example_storages.s3utils.MediaS3BotoStorage'
STATICFILES_STORAGE = 'rpi_server.example_storages.s3utils.StaticS3BotoStorage'
